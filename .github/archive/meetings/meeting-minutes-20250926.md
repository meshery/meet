...
* Amit Amrutiya, Vivek Vishal, Yash Sharma, Zihan Kuang,Baivab Mukhopadhyay, Sangram Rath  
* Varad Gupta, Pratik Chandra Pal,Fiona Murugi, Rafayel Juwe, Sudhanshu Dasgupta  
* Yogendar Singh, Lee Calcote.Oscar Gonzalez, Yash Sharma,Arnav Kapoor, Rajat, Oyefule Oluwatayo  
* Matthieu EVRIN,, Mahadevan KS

Send Regrets: Nikita B, Riya Garg, Aabid sofi, Tanishq Maheswari
...
* ~~\[Nikita B\] \- “default values for schemas”;~~   
* \[Yash Sharma\] \-   
  * KubeCon EU 2025 Wrapup, talks, feedback and security slam  
* What’s next in upcoming KubeCons?  
* \[Bikas\]  Added link / callout to Operator troubleshooting guide \#[14406](https://github.com/meshery/meshery/pull/14406)  
* \[Baivab Mokhopadhyay\] Update\] upgrade alpine base image from 3.19.1 to 3.19.6 \#[14382](https://github.com/meshery/meshery/pull/14382)  
* \[Varad Gupta\] \- E2E Testing of Create and Import Model [\#14388](https://github.com/meshery/meshery/pull/14388)  
* \[Zihan Kuang\] Refactor “Generating Models” Section [\#14414](https://github.com/meshery/meshery/issues/14414)  
* \[Amit Amrutiya\] \-   
  * Workspace UI Update for meshery ui  
  * Convert openapi files into TypeScript object [\#282](https://github.com/meshery/schemas/pull/282)  
...
* \[Faheem Mushtaq\]  
* \[Matthieu EVRIN\]  
  * Documentation update E2E CLI: [\#14371](https://github.com/meshery/meshery/pull/14371)  
  * mesheryctl workspace: [\#14288](https://github.com/meshery/meshery/pull/14288)